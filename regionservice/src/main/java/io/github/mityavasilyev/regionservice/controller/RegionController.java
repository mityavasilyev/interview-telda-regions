...
public class RegionController {
    ...
    @GetMapping("test")
    public void test() {
        service.addRegion(Region.builder().regionName("Hello there").build());
    }

    @GetMapping("regions")
    public List<RegionDTO> getRegions(@RequestParam(value = "search", required = false) String searchString) {
